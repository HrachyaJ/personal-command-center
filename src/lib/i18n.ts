...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "dashboard.section.productivityPatterns": "Productivity Patterns",
    ...
    "dashboard.aiInsights.empty": "No insights yet — check back soon.",
    "dashboard.aiInsights.viewAll": "View all in AI Coach",
    "dashboard.patterns.mostProductive": "Most productive",
    "dashboard.patterns.toughestDay": "Toughest day",
    "dashboard.patterns.toughestDayValue": "{day} · {rate}%",
    "dashboard.patterns.avgTasksPerDay": "Avg. tasks/day",
    "dashboard.patterns.notEnoughData":
      "Not enough activity yet to spot patterns. Complete a few tasks or habits and check back.",
    "dashboard.patterns.seeFullPatterns": "See full patterns →",
    "dashboard.patterns.unavailable": "Patterns unavailable right now.",
  ...
  ru: {
    ...
    "dashboard.section.aiInsights": "ИИ инсайты",
    "dashboard.section.overallProgress": "Общий прогресс",
    "dashboard.section.productivityPatterns": "Паттерны продуктивности",
    ...
    "dashboard.aiInsights.empty": "Пока нет инсайтов — загляните позже.",
    "dashboard.aiInsights.viewAll": "Показать все в ИИ тренере",
    "dashboard.patterns.mostProductive": "Продуктивнее всего",
    "dashboard.patterns.toughestDay": "Самый сложный день",
    "dashboard.patterns.toughestDayValue": "{day} · {rate}%",
    "dashboard.patterns.avgTasksPerDay": "Ср. задач/день",
    "dashboard.patterns.notEnoughData":
      "Пока недостаточно данных для анализа паттернов. Выполните несколько задач или привычек и загляните позже.",
    "dashboard.patterns.seeFullPatterns": "Смотреть все паттерны →",
    "dashboard.patterns.unavailable": "Паттерны временно недоступны.",
    ...
    "dashboard.aiBadge.actions": "Посмотреть инсайты: {count}",
